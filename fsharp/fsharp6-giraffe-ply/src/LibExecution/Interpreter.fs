...
let rec evalAsync (env: Environment.T) (st: Symtable.T) (e: Expr) : Ply.Ply<Dval> =
...
and call_fn_async (env: Environment.T) (fn: Environment.BuiltInFn) (args: List<Dval>) : Ply.Ply<Dval> =
    uply {
